    ...
    <body>  
        ...
        <div class="container pl-0">
            <div class="card p-3 mb-3">
                <!-- {{route('actors.store')}} -->
                <form action="{{route('actors.store')}}" method="POST" class="form" style="width:100%"> 
                    {{csrf_field()}}
                    <h1>Check if the actor already exist in the Database:</h1>
                    ...
                    <hr>
                    <h1>Add an Actor to the Database: </h1>
                        ...
                        <div style="float:left;width:55%;padding-left:5%;padding-right:5%;padding-top:5%;margin-left:5%;">
                            <div class="form-group">
                                ...
                                <textarea name="name" style="width:60%; float:left;margin-right:10%" class="form-control" rows="1" placeholder="Actor Full Name"></textarea>
