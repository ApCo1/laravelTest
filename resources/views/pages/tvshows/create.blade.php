    ...
    <body>  
        ...
        <div class="container pl-0">
            <div class="card p-3 mb-3">
                <form action="{{route('tvshows.store')}}" method="POST" class="form" style="width:100%"> 
                    {{csrf_field()}}
                    <h1>Check if the tvshow already exist in the Database:</h1>
                    ...
                    <table class="table table-hover" id="myTable" style="width:100%">
                        ...
                        <tbody>
                            @foreach($tvshows as $tvshow)
                                <tr class="table-info">
                                    <td scope='row'>{{$tvshow->name}}</td>
                                    <td> {{$tvshow->metaphone}}</td>
                                    <td> {{$tvshow->year_of_release}}</td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
                    <hr>
                    <h1>Add a TV Show to the Database: </h1>
                        ...
                        <div style="float:left;width:55%;padding-left:5%;padding-right:5%;padding-top:5%;margin-left:5%;">
                            <div class="form-group">
                                ...
                                <textarea name="title" class="form-control" rows="1" placeholder="TV Show Title"></textarea>
                                ...
                                <textarea name="year_of_end" class="form-control" style="margin-top:20px; width:40%; float:left; margin-right:10%; margin-left:5%" rows="1" placeholder="Year of End"></textarea>
                                ...
                                <textarea name="no_seasons" class="form-control" style="margin-top:75px; width:100%;" rows="1" placeholder="Number of seasons"></textarea>
                                <textarea name="no_episodes" class="form-control" style="margin-top:75px; width:100%;" rows="1" placeholder="Number of Episodes"></textarea>
                                <p class="pt-3">
                    ...
                    <h1>Check You have the Creator/s in the Database:</h1>
                    ...
                    <table class="table table-hover" id="myTable3" style="width:100%">
                        ...
                        <tbody>
                            ...
                            @foreach($creators as $creator)
                                <tr class="table-info">
                                    <td scope='row'><input type="checkbox" name="creatorid[]" value="{{$creator->id}}"></td>
