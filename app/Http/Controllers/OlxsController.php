...
class OlxsController extends Controller
{
    /**
    ...
    public function __invoke(Request $req){
        $smece = ['1979','1908','1098','800','1403','292','797','166','924','782','792','775','721','835','834','837','2454','2108','832','833','1744','1226','831','1882','1887','1884','1886','1883','1885','1748','247','1608','1764','245','246','2068','2476'];
        function what($id){
            if(!$id){
        ...
        //dd($nresp);
        return view('olxall')->with('nresp',$nresp);
    }
}
